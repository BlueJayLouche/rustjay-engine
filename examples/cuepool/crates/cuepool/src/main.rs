...
mod cue_exec;
use cue_exec::{
    ActiveCue, DelayedCue, PendingStop, fade_elapsed, shift_fade_start_after_pause,
};
mod cue_sequence;
...
mod video_pipeline;
use video_pipeline::{
    CanvasCommand, OutputFrameState, VideoControl, VideoMessage, pixmap_decode_thread,
    video_consume_thread, video_decode_thread,
};
#[cfg(windows)]
