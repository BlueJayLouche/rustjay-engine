    ...
    fn draw(
        ...
        if ui.collapsing_header(
            ...
            co(
                ...
                engine,
                "Rotate Mode##b1",
                &mut state.block3.block1_rotate_mode,
                ROTATE_MODE_OPTS,
            );
            sf(
                ui,
                ...
                "Shear XX##b1",
                "block1_shear_xx",
                &mut state.block3.block1_shear_xx,
                -2.0,
                2.0,
            );
            sf(
                ...
                "Shear XY##b1",
                "block1_shear_xy",
                &mut state.block3.block1_shear_xy,
                -2.0,
                2.0,
            );
            sf(
                ...
                "Shear YX##b1",
                "block1_shear_yx",
                &mut state.block3.block1_shear_yx,
                -2.0,
                2.0,
            );
            sf(
                ...
                "Shear YY##b1",
                "block1_shear_yy",
                &mut state.block3.block1_shear_yy,
                -2.0,
                2.0,
            );
        }
        ...
        if ui.collapsing_header("Block 1 Colorize", imgui::TreeNodeFlags::empty()) {
            cb(
                ...
                engine,
                "Colorize On##b1",
                "block1_colorize_switch",
                &mut state.block3.block1_colorize_switch,
            );
            co(
                ui,
                engine,
            ...
            for i in 1..=5 {
                let (h, s, bri) = match i {
                    1 => (
                        &mut state.block3.block1_colorize_band1_h,
                        &mut state.block3.block1_colorize_band1_s,
                        &mut state.block3.block1_colorize_band1_b,
                    ),
                    2 => (
                        &mut state.block3.block1_colorize_band2_h,
                        &mut state.block3.block1_colorize_band2_s,
                        &mut state.block3.block1_colorize_band2_b,
                    ),
                    3 => (
                        &mut state.block3.block1_colorize_band3_h,
                        &mut state.block3.block1_colorize_band3_s,
                        &mut state.block3.block1_colorize_band3_b,
                    ),
                    4 => (
                        &mut state.block3.block1_colorize_band4_h,
                        &mut state.block3.block1_colorize_band4_s,
                        &mut state.block3.block1_colorize_band4_b,
                    ),
                    5 => (
                        &mut state.block3.block1_colorize_band5_h,
                        &mut state.block3.block1_colorize_band5_s,
                        &mut state.block3.block1_colorize_band5_b,
                    ),
                    _ => unreachable!(),
                };
                ...
                sf(
                    ...
                    engine,
                    &format!("H##b1_band{i}"),
                    &format!("block1_colorize_band{i}_h"),
                    h,
                    0.0,
                    1.0,
                );
                sf(
                    ...
                    engine,
                    &format!("S##b1_band{i}"),
                    &format!("block1_colorize_band{i}_s"),
                    s,
                    0.0,
                    1.0,
                );
                sf(
                    ...
                    engine,
                    &format!("B##b1_band{i}"),
                    &format!("block1_colorize_band{i}_b"),
                    bri,
                    0.0,
                    1.0,
                );
        ...
        if ui.collapsing_header("Block 1 Filters & Dither", imgui::TreeNodeFlags::empty()) {
            ...
            cb(
                ...
                engine,
                "Dither On##b1",
                "block1_dither_switch",
                &mut state.block3.block1_dither_switch,
            );
            co(
                ui,
                engine,
                "Dither Type##b1",
                &mut state.block3.block1_dither_type,
                DITHER_TYPE_OPTS,
            );
            sf(
                ui,
                ...
                "Dither##b1",
                "block1_dither",
                &mut state.block3.block1_dither,
                0.0,
                32.0,
            );
        }
        ...
        if ui.collapsing_header("Block 2 Output Geometry", imgui::TreeNodeFlags::empty()) {
            ...
            co(
                ...
                engine,
                "Rotate Mode##b2",
                &mut state.block3.block2_rotate_mode,
                ROTATE_MODE_OPTS,
            );
            sf(
                ui,
                ...
                "Shear XX##b2",
                "block2_shear_xx",
                &mut state.block3.block2_shear_xx,
                -2.0,
                2.0,
            );
            sf(
                ...
                "Shear XY##b2",
                "block2_shear_xy",
                &mut state.block3.block2_shear_xy,
                -2.0,
                2.0,
            );
            sf(
                ...
                "Shear YX##b2",
                "block2_shear_yx",
                &mut state.block3.block2_shear_yx,
                -2.0,
                2.0,
            );
            sf(
                ...
                "Shear YY##b2",
                "block2_shear_yy",
                &mut state.block3.block2_shear_yy,
                -2.0,
                2.0,
            );
        }
        ...
        if ui.collapsing_header("Block 2 Colorize", imgui::TreeNodeFlags::empty()) {
            cb(
                ...
                engine,
                "Colorize On##b2",
                "block2_colorize_switch",
                &mut state.block3.block2_colorize_switch,
            );
            co(
                ui,
                engine,
            ...
            for i in 1..=5 {
                let (h, s, bri) = match i {
                    1 => (
                        &mut state.block3.block2_colorize_band1_h,
                        &mut state.block3.block2_colorize_band1_s,
                        &mut state.block3.block2_colorize_band1_b,
                    ),
                    2 => (
                        &mut state.block3.block2_colorize_band2_h,
                        &mut state.block3.block2_colorize_band2_s,
                        &mut state.block3.block2_colorize_band2_b,
                    ),
                    3 => (
                        &mut state.block3.block2_colorize_band3_h,
                        &mut state.block3.block2_colorize_band3_s,
                        &mut state.block3.block2_colorize_band3_b,
                    ),
                    4 => (
                        &mut state.block3.block2_colorize_band4_h,
                        &mut state.block3.block2_colorize_band4_s,
                        &mut state.block3.block2_colorize_band4_b,
                    ),
                    5 => (
                        &mut state.block3.block2_colorize_band5_h,
                        &mut state.block3.block2_colorize_band5_s,
                        &mut state.block3.block2_colorize_band5_b,
                    ),
                    _ => unreachable!(),
                };
                ui.text(format!("Band {i}"));
                sf(
                    ...
                    engine,
                    &format!("H##b2_band{i}"),
                    &format!("block2_colorize_band{i}_h"),
                    h,
                    0.0,
                    1.0,
                );
                sf(
                    ...
                    engine,
                    &format!("S##b2_band{i}"),
                    &format!("block2_colorize_band{i}_s"),
                    s,
                    0.0,
                    1.0,
                );
                sf(
                    ...
                    engine,
                    &format!("B##b2_band{i}"),
                    &format!("block2_colorize_band{i}_b"),
                    bri,
                    0.0,
                    1.0,
                );
        ...
        if ui.collapsing_header("Block 2 Filters & Dither", imgui::TreeNodeFlags::empty()) {
            ...
            cb(
                ...
                engine,
                "Dither On##b2",
                "block2_dither_switch",
                &mut state.block3.block2_dither_switch,
            );
            co(
                ui,
                engine,
                "Dither Type##b2",
                &mut state.block3.block2_dither_type,
                DITHER_TYPE_OPTS,
            );
            sf(
                ui,
                ...
                "Dither##b2",
                "block2_dither",
                &mut state.block3.block2_dither,
                0.0,
                32.0,
            );
        }
        ...
        if ui.collapsing_header("Matrix Mixer", imgui::TreeNodeFlags::empty()) {
            co(
                ...
                engine,
                "Mix Type##mat",
                &mut state.block3.matrix_mix_type,
                MIX_TYPE_OPTS,
            );
            co(
                ui,
                engine,
                "Mix Overflow##mat",
                &mut state.block3.matrix_mix_overflow,
                MIX_OVERFLOW_OPTS,
            );
            ui.text("R →");
            sf(
                ...
                "R→R",
                "matrix_mix_r_to_r",
                &mut state.block3.matrix_mix_r_to_r,
                -2.0,
                2.0,
            );
            sf(
                ...
                "R→G",
                "matrix_mix_r_to_g",
                &mut state.block3.matrix_mix_r_to_g,
                -2.0,
                2.0,
            );
            sf(
                ...
                "R→B",
                "matrix_mix_r_to_b",
                &mut state.block3.matrix_mix_r_to_b,
                -2.0,
                2.0,
            );
            ui.text("G →");
            sf(
                ...
                "G→R",
                "matrix_mix_g_to_r",
                &mut state.block3.matrix_mix_g_to_r,
                -2.0,
                2.0,
            );
            sf(
                ...
                "G→G",
                "matrix_mix_g_to_g",
                &mut state.block3.matrix_mix_g_to_g,
                -2.0,
                2.0,
            );
            sf(
                ...
                "G→B",
                "matrix_mix_g_to_b",
                &mut state.block3.matrix_mix_g_to_b,
                -2.0,
                2.0,
            );
            ui.text("B →");
            sf(
                ...
                "B→R",
                "matrix_mix_b_to_r",
                &mut state.block3.matrix_mix_b_to_r,
                -2.0,
                2.0,
            );
            sf(
                ...
                "B→G",
                "matrix_mix_b_to_g",
                &mut state.block3.matrix_mix_b_to_g,
                -2.0,
                2.0,
            );
            sf(
                ...
                "B→B",
                "matrix_mix_b_to_b",
                &mut state.block3.matrix_mix_b_to_b,
                -2.0,
                2.0,
            );
        }
        ...
        if ui.collapsing_header("Final Mix & Key", imgui::TreeNodeFlags::empty()) {
            sf(
                ...
                "Final Mix Amount",
                "final_mix_amount",
                &mut state.block3.final_mix_amount,
                0.0,
                1.0,
            );
            co(
                ...
                engine,
                "Mix Type##final",
                &mut state.block3.final_mix_type,
                MIX_TYPE_OPTS,
            );
            co(
                ui,
                engine,
                "Mix Overflow##final",
                &mut state.block3.final_mix_overflow,
                MIX_OVERFLOW_OPTS,
            );
            co(
                ui,
                engine,
                "Key Order##final",
                &mut state.block3.final_key_order,
                KEY_ORDER_OPTS,
            );
            co(
                ui,
                engine,
                "Key Mode##final",
                &mut state.block3.final_key_mode,
                KEY_MODE_OPTS,
            );
            sf(
                ui,
        ...
        if ui.collapsing_header("Final Dither", imgui::TreeNodeFlags::empty()) {
            cb(
                ...
                "Dither On##final",
                "final_dither_switch",
                &mut state.block3.final_dither_switch,
            );
            co(
                ui,
                engine,
                "Dither Type##final",
                &mut state.block3.final_dither_type,
                DITHER_TYPE_OPTS,
            );
            sf(
                ui,
        ...
        if ui.collapsing_header("Presets & Import", imgui::TreeNodeFlags::empty()) {
            ...
            if ui
                .slider_config("Max Delay Frames", 1, 60)
                .build(&mut max_delay)
            {
                state.max_delay_frames = max_delay as u32;
            }
            let estimate_mb =
                (state.max_delay_frames as usize) * 2 * (w as usize) * (h as usize) * 4
                    / (1024 * 1024);
            ui.same_line();
