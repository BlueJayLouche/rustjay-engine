...
pub fn waaaves_parameter_descriptors() -> Vec<ParameterDescriptor> {
    ...
    vec![
        ...
        f!(
            "ch1_kaleidoscope_slice",
            "CH1 Kaleidoscope Slice",
            b1_ch1.clone(),
            -std::f32::consts::PI,
            std::f32::consts::PI,
            0.0,
        ...
        f!(
            "ch2_kaleidoscope_slice",
            "CH2 Kaleidoscope Slice",
            b1_ch2.clone(),
            -std::f32::consts::PI,
            std::f32::consts::PI,
            0.0,
        ...
        f!(
            "fb1_kaleidoscope_slice",
            "FB1 Kaleidoscope Slice",
            b1_fb1.clone(),
            -std::f32::consts::PI,
            std::f32::consts::PI,
            0.0,
        ...
        f!(
            "fb2_kaleidoscope_slice",
            "FB2 Kaleidoscope Slice",
            b2_fb2.clone(),
            -std::f32::consts::PI,
            std::f32::consts::PI,
            0.0,
