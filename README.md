...
│   ├── kovvboj             # Full multi-deck VJ application
...
cargo run -p kovvboj       # Full multi-deck VJ app (--all-features for NDI/Syphon/Spout)
...
| 9 | ✅ | Multi-deck VJ app (kovvboj) — mixer, FX chains, scene topology persistence |
